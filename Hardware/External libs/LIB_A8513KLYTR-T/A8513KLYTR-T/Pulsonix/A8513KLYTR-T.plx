...
//15717798/1280117/2.50/11/2/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOP50P488X106-11N" (originalName "SOP50P488X106-11N")
		(multiLayer
			...
			(pad (padNum 11) (padStyleRef r200_160) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "A8513KLYTR-T" (originalName "A8513KLYTR-T")
	...
	(compDef "A8513KLYTR-T" (originalName "A8513KLYTR-T") (compHeader (numPins 11) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "SW") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "OVP") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "10" (pinName "COMP") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "GND_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "ISET") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "EN/PWM") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "LED") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "A8513KLYTR-T"))
		(attachedPattern (patternNum 1) (patternName "SOP50P488X106-11N")
			(numPads 11)
			(padPinMap
		...
		(attr "Arrow Part Number" "A8513KLYTR-T")
		(attr "Arrow Price/Stock" "")
		(attr "Manufacturer_Name" "Allegro Microsystems")
		(attr "Manufacturer_Part_Number" "A8513KLYTR-T")
		(attr "Description" "Backlight Driver For Small/Medium Size LCDs")
		(attr "<Hyperlink>" "http://www.allegromicro.com/~/media/files/datasheets/a8513-datasheet.pdf")
		(attr "<Component Height>" "1.06")
		(attr "<STEP Filename>" "A8513KLYTR-T.stp")
